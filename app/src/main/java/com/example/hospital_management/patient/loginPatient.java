package com.example.hospital_management.patient;
...
import com.example.hospital_management.patient.fragments.PatientHomeFragment;
import com.example.hospital_management.patient.fragments.PatientProfileFragment;
...
public class loginPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_nav_patient);
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            @Override
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                int menuItemId =  item.getItemId();

                if(menuItemId == R.id.patient_home){
                    replaceFragment(new PatientHomeFragment());
                    return true;
                }
//                else if (menuItemId ==  R.id.patient_emergency) {
//                    replaceFragment(new PatientSOSFragment());
//                    return true;
//                }
                else if (menuItemId ==  R.id.patient_profile) {
...
////           , appointment_date, appointment_patient_id, appointment_doctor_id, appointment_allergies_mentioned;
//    AutoCompleteTextView textview_doctorname, textview_fees;
//    RelativeLayout layout_myprofile, layout_bookappointment, layout_appointment_history;
...
//
////        layout_appointment_history=findViewById(R.id.layoutAppointmentHistory);
////
////        appointment_date = findViewById(R.id.appointment_date);
////        appointment_patient_id = findViewById(R.id.appointment_patient_id);
////        appointment_doctor_id =  findViewById(R.id.appointment_doctor_id);
////        appointment_allergies_mentioned =  findViewById(R.id.appointment_allergies_mentioned);
//
//
//
...
//        view_appointment_history.setOnClickListener(loginPatient.this);
...
//                if(patient==null){
//                    Toast.makeText(loginPatient.this,"Something went wrong, Try Again!", Toast.LENGTH_SHORT).show();
//                }
//                else{
...
//                break;
//
//            case R.id.buttonViewAppointmentHistory:
//                progressBar.setVisibility(View.VISIBLE);
//                Intent intent2=new Intent(loginPatient.this, ViewAppointmentHistory.class);
...
//                        else{
//                            progressBar.setVisibility(View.GONE);
//                            Toast.makeText(loginPatient.this,"Something went wrong, Try again!",Toast.LENGTH_LONG).show();
//                        }
//                    }
//                });
//    }
...
//                Toast.makeText(loginPatient.this,"Fees Applicable::"+doctor.getDoctorFees(),Toast.LENGTH_LONG).show();
