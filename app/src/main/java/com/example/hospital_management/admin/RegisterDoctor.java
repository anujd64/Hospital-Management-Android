                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Doctor doctor=new Doctor(uid,firstName,lastName,email,password,mobile,address,editTextFees.getText().toString(),editTextDegree.getText().toString(),editTextSpecialization.getText().toString(),"FCMToken");
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            ...
                                            if (task.isSuccessful()) {
                                                ...
                                                Toast.makeText(RegisterDoctor.this, "Something went wrong, Try Again!", Toast.LENGTH_LONG).show();
                                            }
                                        }
                                    });
                        }
